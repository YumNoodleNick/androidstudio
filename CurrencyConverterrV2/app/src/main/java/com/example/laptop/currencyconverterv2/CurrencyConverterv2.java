package com.example.laptop.currencyconverterv2;
...
public class CurrencyConverterv2 extends AppCompatActivity {

    Spinner spinner;
    ListView listView;
    TextView datumTextView;

    final String[] KEYS = {"EUR", "USD", "GBP", "KRW", "JPY" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_currency_converterv2);
    ...
    private void maakListView(){
        ...
        for (int i = 0; 1 < currencies.size(); i++){
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_currency_converterv2, menu);
        return true;
    }
